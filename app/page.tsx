  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      <section className="relative min-h-screen overflow-hidden ">
        ...
        <div className="relative z-10 flex min-h-screen flex-col items-center justify-evenly text-center px-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-2xl md:text-3xl font-light tracking-widest"> per Donna, Uomo e Bambini</h3>

            <p className="mt-6 text-gray-300 max-w-md">
              Taglio, colore, barba moderni e personalizzati <br />a Guidonia Montecelio Roma
            </p>
          </div>
      ...
      <section className="px-8 py-16 bg-neutral-700 text-white text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold uppercase playfair_text">
            Il Tuo Salone di Parrucchiere e Make-up <br />a Guidonia Montecelio
          </h2>
          <p className="text-md md:text-md leading-relaxed">
            Benvenuti nel nostro salone, il punto di riferimento per chi cerca tagli moderni, colore professionale e trattamenti personalizzati per donna, uomo e bambino.
          ...
          <p className="mt-4 font_mission uppercase">La tua bellezza è la nostra MISSIONE</p>

          <p className="text-md md:text-md leading-relaxed">
            Prenota il tuo appuntamento oggi stesso e scopri perché il nostro salone è il preferito a Guidonia Montecelio per taglio, colore, barba e make-up professionale.<br />
      ...
      <section className="px-8 py-16 bg-neutral-700 text-white text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold uppercase playfair_text">
            Bellezza, Stile e Cura dei Capelli <br /> a Guidonia Montecelio
          </h2>
          <p className="text-md md:text-md leading-relaxed">
            Scopri il nostro salone, il luogo ideale dove ogni taglio, colore e trattamento è studiato
          </p>
          <p className="mt-4 font_mission uppercase"> per valorizzare la tua unicità</p>
          <p>
            Offriamo servizi professionali per donna, uomo e bambino, con attenzione ai dettagli e alle ultime tendenze del mondo della bellezza.
          </p>
          <p className="text-md md:text-md leading-relaxed">
            Situati vicino alla Tiburtina, uniamo creatività e competenza per offrirti un’esperienza completa: dai tagli moderni alla colorazione personalizzata, fino al make-up professionale per ogni occasione </p>
          <p className="font_mission uppercase text-md md:text-md leading-relaxed">
            Ogni cliente esce dal nostro salone sentendosi speciale
          </p>
          <p className="text-md md:text-md leading-relaxed">
            <span className="font_mission uppercase">Prenota subito il tuo appuntamento </span> e lasciati coccolare da professionisti esperti che trasformano la cura dei capelli in arte.
        ...
        <>
          <section className="px-8 py-16 bg-neutral-700 text-white text-center">
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <p className="text-md md:text-md leading-relaxed">
                Il nostro salone, situato vicino alla Tiburtina a Guidonia Montecelio, unisce qualità, stile e professionalità </p>
              <p className="font_mission">Ogni servizio è studiato per offrirti un’esperienza unica</p>
              <p> e le nostre offerte in corso rendono il momento perfetto per prenotare.
              </p>
              <p className="text-md md:text-md leading-relaxed">
                Scorri qui sotto e scopri l’immagine con tutte le promozioni attive <br />
