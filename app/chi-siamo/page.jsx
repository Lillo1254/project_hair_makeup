...
export default function ChiSiamo() {
  ...
  return (
    <div className="bg-gradient-to-b from-black via-neutral-900 to-neutral-800 text-white">
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 items-center">
          <Image src={alterego[0]} alt="Prodotti professionali capelli" width={400} height={600} className="rounded-2xl mx-auto" />
          ...
          <Image src={selective} alt="Linea prodotti parrucchiere" width={400} height={600} className="rounded-2xl mx-auto" />
        </div>
      </section>

      {/* POSTAZIONI */}
      <section className="px-6 py-16 grid md:grid-cols-2 gap-10 max-w-6xl mx-auto items-center">
        <Image src={negozio[2]} alt="Postazione parrucchiere moderna" width={400} height={700} className="rounded-2xl mx-auto" />
        <Image src={negozio[1]} alt="Postazione styling capelli" width={400} height={700} className="rounded-2xl mx-auto" />
      </section>

      {/* LAVAGGIO */}
      <section className="px-6 py-16 grid md:grid-cols-2 gap-10 max-w-6xl mx-auto items-center">
        <Image src={negozio[3]} alt="Zona lavaggio relax parrucchiere" width={400} height={700} className="rounded-2xl mx-auto" />
        <p className="text-gray-300 text-center md:text-left leading-relaxed">
      ...
      <section className="px-6 py-16 text-center max-w-5xl mx-auto">
        <Image src={attrezzatura} alt="Attrezzatura parrucchiere professionale" width={900} height={500} className="rounded-2xl mx-auto" />
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {negozio.slice(0, 3).map((img, i) => (
            <Image key={i} src={img} alt="Facciata salone parrucchiere Guidonia" width={400} height={600} className="rounded-2xl mx-auto" />
          ))}
        </div>
